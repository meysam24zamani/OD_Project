...
public class Exercise_2 {
    ...
    private static class VProg extends AbstractFunction3<Long, Integer, Integer, Integer> implements Serializable {
        ...
        public Integer apply(Long vertexID, Integer vertexValue, Integer message) {
            if (message == Integer.MAX_VALUE) {             // superstep 0
                //				System.out.printf("APPLY vertexId=%d vertexValue=%d message=MAXVAL return=%d\n", vertexID, vertexValue, vertexValue);
                return vertexValue;
            } else {                                        // superstep > 0
                //				System.out.printf("APPLY vertexId=%d vertexValue=%d message=%d return=%d\n", vertexID, vertexValue, message, Math.min(vertexValue, message));
    ...
    private static class sendMsg extends AbstractFunction1<EdgeTriplet<Integer, Integer>, Iterator<Tuple2<Object, Integer>>> implements Serializable {
        ...
        public Iterator<Tuple2<Object, Integer>> apply(EdgeTriplet<Integer, Integer> triplet) {
            ...
            //Send empty message if new value is greater than the destination's existing value
            if (sourceVertex._2 == Integer.MAX_VALUE || sourceVertex._2 + triplet.attr() > dstVertex._2) {
                //				System.out.printf("SCATTER src=%d(%d) dst=%d(%d) return=EMPTY\n", sourceVertex._1, sourceVertex._2, dstVertex._1, dstVertex._2);
                return JavaConverters.asScalaIteratorConverter(new ArrayList<Tuple2<Object, Integer>>().iterator()).asScala();
            } else {
                //				System.out.printf("SCATTER src=%d(%d) dst=%d(%d) return=%d(%d)\n", sourceVertex._1, sourceVertex._2, dstVertex._1, dstVertex._2, triplet.dstId(), sourceVertex._2 + triplet.attr());
    ...
    private static class merge extends AbstractFunction2<Integer, Integer, Integer> implements Serializable {
        ...
        public Integer apply(Integer o, Integer o2) {
            //			System.out.printf("GATHER o=%d o2=%d return=%d\n", o, o2, Math.min(o, o2));
    ...
    public static void shortestPaths(JavaSparkContext ctx) {
        ...
        ops.pregel(Integer.MAX_VALUE,
                ...
                .vertices()
                .toJavaRDD()
                .sortBy(v1 -> labels.get(((Tuple2) v1)._1), true, 1)
                .foreach(v -> {
