...
public class Exercise_3 {
    ...
    public static class VProg extends AbstractFunction3<Long, Tuple2<String, Integer>, Tuple2<String, Integer>, Tuple2> implements Serializable {
        ...
        public Tuple2 apply(Long vertexID, Tuple2<String, Integer> vertexValue, Tuple2<String, Integer> message) {
            if (message._2 == Integer.MAX_VALUE) {             // superstep 0
                //				System.out.printf("APPLY vertexId=%s vertexValue=%s message=MAXVAL return=%s\n", vertexID, vertexValue, vertexValue);
                return vertexValue;
            } else {
                //				System.out.printf("APPLY vertexId=%s vertexValue=%s message=%s return=%s\n", vertexID, vertexValue, message, Math.min(vertexValue._2, message._2));
    ...
    public static class sendMsg extends AbstractFunction1<EdgeTriplet<Tuple2, Integer>, Iterator<Tuple2<Object, Tuple2>>> implements Serializable {
        ...
        public Iterator<Tuple2<Object, Tuple2>> apply(EdgeTriplet<Tuple2, Integer> triplet) {
            ...
            Tuple2<Object, Tuple2> dstVertex = triplet.toTuple()._2();

            if ((Integer) sourceVertex._2._2 == Integer.MAX_VALUE || (Integer) sourceVertex._2._2 + triplet.attr() > (Integer) dstVertex._2._2) {
                //				System.out.printf("SCATTER src=%s(%s) dst=%s(%s) return=EMPTY\n", sourceVertex._1, sourceVertex._2, dstVertex._1, dstVertex._2);
                return JavaConverters.asScalaIteratorConverter(new ArrayList<Tuple2<Object, Tuple2>>().iterator()).asScala();
            } else {
                Tuple2 msg = new Tuple2(sourceVertex._2._1 + "," + labels.get(dstVertex._1), (Integer) sourceVertex._2._2 + triplet.attr());
                //				System.out.printf("SCATTER src=%s(%s) dst=%s(%s) message=%s(%s)\n", sourceVertex._1, sourceVertex._2, dstVertex._1, dstVertex._2, triplet.dstId(), msg);
    ...
    public static class merge extends AbstractFunction2<Tuple2<String, Integer>, Tuple2<String, Integer>, Tuple2<String, Integer>> implements Serializable {
        ...
        public Tuple2<String, Integer> apply(Tuple2<String, Integer> o, Tuple2<String, Integer> o2) {
            Tuple2<String, Integer> result = (o._2 <= o2._2) ? o : o2;
            System.out.printf("GATHER o=%s o2=%s return=%s\n", o, o2, result);
            return result;
        }
    }
